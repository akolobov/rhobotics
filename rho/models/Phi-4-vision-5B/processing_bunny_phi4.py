"""
Processor class for Bunny-Phi4.

This module provides:
- BunnyPhi4Processor: Combined tokenizer and image processor
...
from .modeling_bunny_phi4 import (
    IMAGE_TOKEN_INDEX,
    DEFAULT_IMAGE_TOKEN,
)
...
class BunnyPhi4Processor(ProcessorMixin):
    """
    Processor for Bunny-Phi4 that wraps an image processor and tokenizer.
    ...
    def __call__(
        ...
        **kwargs,
        ...
        Returns:
            BatchFeature with input_ids, attention_mask, and optionally images.
        """
        # Process images
    ...
    def from_pretrained(cls, pretrained_model_name_or_path, **kwargs):
        ...
        try:
            ...
            if vision_tower_name and 'naflex' in vision_tower_name.lower():
                from .modeling_bunny_phi4 import Siglip2ImageProcessorNoUpscale
...
def prepare_inputs_for_generation(
    ...
    Args:
        ...
        processor: The BunnyPhi4Processor
